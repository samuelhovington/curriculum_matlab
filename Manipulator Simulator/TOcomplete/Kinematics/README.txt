...
The files necessary for each pratical activity are
    ...
    PA #2 : Looking at Jaco's DH parameters
            --> Verification_DH_FK_to_complete.m

    PA #3 : Angular and Cartesian Positioning
            --> fowardKinematicsJaco6DOFS_to_complete.m and Verification_DH_FK_to_complete.m

    PA #4 : Velocitites and Accelerations
            --> No files Matlab for this lab

    PA #5 : Jacobian
            --> Jacobian_to_complete.m and Verification_Jacobian_to_complete.m

    PA #6 : Inverse Kinematics of a 6 DOF robot manipulator
            --> InverseKinematics_to_complete.m and Verification_InverseKinematics_to_complete.m
