...
Rad2Deg = 180/pi;
%File that runs the verification of the polynomial trajectory planner with 
%via point function. Change indicated lines to make the script work 
%correctly.
...
% JntPos = TrajectoryPlanner_6DOFS_CPV_complete(theta_i, theta_v, theta_g, desired_time);
JntPos = TrajectoryPlanner_6DOFS_CPV_to_complete(theta_i, theta_v, theta_g, desired_time);
...
uiwait(msgbox({txt1 txt2 txt3 txt4}, 'Polynomial Via Points Planner'));
